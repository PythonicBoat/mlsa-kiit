...
import { EVENTS2020, EVENTS2021, EVENTS2022, EVENTS2023, EVENTS2024 } from "@/constants";
            ...
            <div className="max-w-[1920px] md:pt-[100px] bg-black mx-auto p-[5vw]  ">
                ...
                <div className=" flex flex-col-reverse  md:flex-row">
                    <div className="relative">
                        ...
                        <div className="absolute bottom-[45px] left-[18px] text-base 3xl:text-3xl font-medium drop-shadow-2xl" style={{ textShadow: " 1.5px 1.5px black", lineHeight: "normal" }}>12-14th December 2024</div>
                        ...
                        <div className="absolute bottom-[72px] left-[18px] text-xl 3xl:text-3xl font-medium drop-shadow-2xl" style={{ textShadow: " 1.5px 1.5px black", lineHeight: "normal" }}>Hackocalypse</div>
                    </div>
